...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    FzfLuaNormal(Normal),
    FzfLuaMatchCaret({ fg = paletth.light_blue }),
    ...
    -- FzfLuaPreviewTitle({ fg = palette.green }),
    -- FzfLuaCursor({ fg = palette.green }),
    -- FzfLuaCursorLine({ fg = palette.green }),
    -- FzfLuaCursorLineNr({ fg = palette.green }),
    -- FzfLuaSearch({ fg = palette.green }),
    -- FzfLuaScrollBorderEmpty({ fg = palette.green }),
    -- FzfLuaScrollBorderFull({ fg = palette.green }),
    -- FzfLuaScrollFloatEmpty({ fg = palette.green }),
    -- FzfLuaScrollFloatFull({ fg = palette.green }),
    -- FzfLuaDirIcon({ fg = palette.green }),
    -- FzfLuaDirPart({ fg = palette.green }),
    -- FzfLuaFilePart({ fg = palette.green }),
    -- FzfLuaHeaderBind({ fg = palette.green }),
    -- FzfLuaPathColNr({ fg = palette.green }),
    -- FzfLuaBufName({ fg = palette.green }),
    -- FzfLuaBufFlagAlt({ fg = palette.green }),
    -- FzfLuaTabTitle({ fg = palette.green }),
    -- FzfLuaFzfNormal({ fg = palette.green }),
    -- FzfLuaFzfCursorLine({ fg = palette.green }),
    -- FzfLuaFzfScrollbar({ fg = palette.green }),
    -- FzfLuaFzfSeparator({ fg = palette.green }),
    -- FzfLuaFzfGutter({ fg = palette.green }),
    -- FzfLuaFzfHeader({ fg = palette.green }),
    -- FzfLuaFzfInfo({ fg = palette.green }),
    -- FzfLuaFzfMarker({ fg = palette.green }),

...
keymap(
  "n",
  "<leader>ff",
  "<cmd>lua require'telescope.builtin'.find_files(require('telescope.themes').get_dropdown({previewer = false,hidden = true,find_command = {'rg', '--files', '--hidden', '--glob', '!.git/*', '--glob', '!node_modules/*', '--glob', '!vendor/*', '--glob', '!lang/*'},no_ignore = true}))<cr>",
  opts
)

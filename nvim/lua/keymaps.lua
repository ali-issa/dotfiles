...
keymap("n", "<leader>ce", "<cmd>lua vim.diagnostic.setqflist()<cr>", opts)
...
keymap(
  "n",
  "<leader>ff",
  "<cmd>lua require'telescope.builtin'.find_files(require('telescope.themes').get_dropdown({previewer = false,hidden = true,find_command = {'rg', '--files', '--hidden', '--glob', '!.git/*', '--glob', '!node_modules/*', '--glob', '!.next/*', '--glob', '!dist/*', '--glob', '!vendor/*', '--glob', '!lang/*'},no_ignore = true}))<cr>",
  opts
)
...
keymap(
  "n",
  "<leader>fP",
  "<cmd>lua require'telescope.builtin'.registers(require('telescope.themes').get_dropdown({ previewer = false, hidden = true }) )<cr>",
  opts
)
keymap(
  "n",
  "<leader>fk",
  "<cmd>lua require'telescope.builtin'.keymaps(require('telescope.themes').get_dropdown({ previewer = false, hidden = true }) )<cr>",
  opts
)
